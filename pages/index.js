export default function Home() {
  return (
    <div className="min-h-screen bg-[#F6F1EB]">
      ...
      <section className="relative h-screen flex items-center justify-center text-center text-white pt-20">
        ...
        <div className="relative z-10 max-w-2xl px-4">
          ...
          <p className="mt-6 text-lg text-gray-200">
            Work with Dr. Maya Reynolds to build clarity, emotional strength, and healthier connections.
          </p>

          <button className="mt-8 px-8 py-3 bg-white text-[#2E4057] rounded-full font-semibold">
            Book a Consultation
          </button>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="bg-white p-6 rounded-xl shadow">
              <h3 className="text-xl font-semibold text-[#2E4057]">Anxiety Therapy</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow">
              <h3 className="text-xl font-semibold text-[#2E4057]">Relationship Counseling</h3>
              <p className="mt-3 text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow">
              <h3 className="text-xl font-semibold text-[#2E4057]">Trauma Support</h3>
              <p className="mt-3 text-gray-600">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <button className="mt-6 px-6 py-3 bg-[#2E4057] text-white rounded">
              Learn More
            </button>
          </div>
      ...
      {/* CTA */}
      <section className="py-20 px-6 bg-[#2E4057] text-white text-center">
        <h2 className="text-3xl font-bold">
          Ready to Start Your Healing Journey?
        </h2>

        <button className="mt-6 px-8 py-3 bg-white text-[#2E4057] rounded-full font-semibold">
          Book a Session
        </button>
      </section>
      ...
      <section className="py-20 px-6 bg-white text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-10">
          <img src="https://images.unsplash.com/photo-1505691938895-1758d7feb511" className="rounded-lg h-64 w-full object-cover"/>
          <img src="https://images.unsplash.com/photo-1497366216548-37526070297c" className="rounded-lg h-64 w-full object-cover"/>
          <img src="https://images.unsplash.com/photo-1507089947368-19c1da9775ae" className="rounded-lg h-64 w-full object-cover"/>
        </div>
      </section>
